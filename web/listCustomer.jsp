<%-- 
    ...
    Created on : 8 Jan 2025, 9:44:43 pm
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Customers of Coin Laundry System</h1>
                            </div><!-- /.col -->        
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                </div>
                                            ...
                                            <tbody>
                                                <%
                                                    for (Customer e : list) {
                                                        ...
                                                        out.print("<tr><td>" + e.getCustID() + "</td><td>" + e.getCustName() + "</td><td>" + e.getCustPhone() + "</td><td>" + e.getCustEmail() + "</td><td>" + e.getCustAddress() + "</td>");
                                                        out.print("<td class='project-actions'>"            
                                                                + "<a class='btn btn-danger btn-sm' href='DeleteCustServlet?custID=" + e.getCustID() + "'>"
