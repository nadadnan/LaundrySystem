    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- /.content-header -->
<%
    Integer newOrderCount = (Integer) request.getAttribute("newOrderCount");
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="small-box bg-info">
                                    <div class="inner">
                                    <h3><%= newOrderCount %> New Orders</h3>
                                        <p>List Of New Orders</p>
                                    </div>
                                    <div class="icon">
                                        <i class="ion ion-bag"></i>
                                    </div>
                                    <a href="view_orders.jsp" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="small-box bg-warning">
                                    ...
                                    <a href="listCustomer.jsp" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="small-box bg-success">
                                    ...
                                    <a href="view_reports.jsp" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>                           
                        </div>
