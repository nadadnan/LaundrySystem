...
<html lang="en">
    <head>
        ...
        <title>Test Deliver Personnel dashboard</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="delPerson_dashboard.jsp" class="nav-link">Home</a>
                    </li>
                </ul>
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                <!-- Brand Logo -->
                <a href="delPerson_dashboard.jsp" class="brand-link">
                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="delPerson_dashboard.jsp" class="nav-link active">
                            ...
                            <li class="nav-item">
                                <a href="view_jobs.jsp" class="nav-link">
                            ...
                            <!--li class="nav-item">
                                <a href="pages/menu.jsp" class="nav-link">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Update Orders Status</h1>
                            </div><!-- /.col -->        
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                </div>
...
<table class="table table-hover text-nowrap">
    ...
    <tbody>
        <%
            for (Orders order : staffOrders) {
                String orderStatus = order.getOrderStatus();
                if (!"Completed".equals(orderStatus)) {
        %>
        <tr>
            <td><%= order.getOrderID() %></td>
            <td><%= order.getAssignedStaffName() != null ? order.getAssignedStaffName() : "Unknown" %></td>
            ...
            <td>
                <form action="UpdateOrderStatusServlet" method="post" class="d-flex align-items-center">
                    ...
                    <select name="orderStatus" class="form-control mr-2" style="width:auto;">
                        ...
                        <option value="In Delivery to Laundry" <%= "In Delivery to Laundry".equals(orderStatus) ? "selected" : "" %>>In Delivery to Laundry</option>
                        <option value="In Laundry" <%= "In Laundry".equals(orderStatus) ? "selected" : "" %>>In Laundry</option>
                        <% if ("Operational Staff".equals(role)) { %>
                        <option value="Ready for Delivery" <%= "Ready for Delivery".equals(orderStatus) ? "selected" : "" %>>Ready for Delivery</option>
                        <% } %>
                        <option value="Out for Delivery" <%= "Out for Delivery".equals(orderStatus) ? "selected" : "" %>>Out for Delivery</option>
                        <option value="Completed" <%= "Completed".equals(orderStatus) ? "selected" : "" %>>Completed</option>
                    </select>
                    <button type="submit" class="btn btn-sm btn-primary ml-2">Update</button>
                </form>
            </td>
            <td><a href="view_job_details.jsp?orderID=<%= order.getOrderID() %>" class="btn btn-primary btn-action">View Details</a></td> <!-- Show details -->
        </tr>
        <%
                }
            }
